...
class ResourceStatus(StrEnum):
    ...
    DEPLOYED = "deployed"           # Currently deployed to an incident in field
    UNAVAILABLE = "unavailable"     # Out of service / maintenance / offline
    STANDBY = "standby"             # On alert but not yet dispatched
    ASSIGNED = "assigned"           # Selected for an incident action
    COMPLETED = "completed"         # Finished deployment and returning
